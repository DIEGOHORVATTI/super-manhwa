...
export const myConnector: MangaConnector = {
  ...
  async getPopular(page) {/* return { list, hasNextPage } */},
  async search(query, page) {/* return { list, hasNextPage } */},
  async getDetail(link) {/* return RawDetail */},
  async getPageList(chapterUrl) {/* return Array<string | { url }> */},
};
```
