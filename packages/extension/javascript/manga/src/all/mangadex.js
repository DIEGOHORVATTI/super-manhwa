const mangayomiSources = [
  {
    ...
    iconUrl:
      "https://raw.githubusercontent.com/m2k3a/mangayomi-extensions/main/javascript/icon/all.mangadex.png",
    typeSource: "single",
    itemType: 0,
    version: "0.1.4",
...
class DefaultExtension extends MProvider {
    ...
    const mangaIds = Array.from(
      new Set(
        JSON.parse(response.body)
          .data.flatMap((item) => item.relationships)
  ...
  async getDetail(url) {
    ...
    manga.description =
      data.attributes.description[this.source.lang] ?? data.attributes.description.en ?? "";
    ...
    return [
      ...
      },
      {
        ...
        multiSelectListPreference: {
          ...
          entries: ["Japanese", "Chinese", "Korean"],
          entryValues: [
            "originalLanguage[]=ja",
