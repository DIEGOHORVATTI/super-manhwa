 ...
 * 🗳️ Variants
 * **********************************************************************/
const thumbVariants = SIZES.map((size) => ({
...
const railVariants = ORIENTATIONS.flatMap((orientation) =>
  SIZES.map((size) => ({
...
const trackVariants = ORIENTATIONS.flatMap((orientation) =>
  SIZES.map((size) => ({
    props: (props) => props.orientation === orientation && props.size === size,
    style:
      orientation === "horizontal"
...
const markVariants = ORIENTATIONS.flatMap((orientation) =>
  SIZES.map((size) => ({
    props: (props) => props.orientation === orientation && props.size === size,
    style:
      orientation === "horizontal"
